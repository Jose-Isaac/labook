...
const followBusiness = (friendRelationship) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield new friendRelationship_1.friendRelationshipDatabase().create(relationship);
});
exports.followBusiness = followBusiness;
//# sourceMappingURL=followBusines.js.map